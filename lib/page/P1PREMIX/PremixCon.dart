...
void PREMIXConsoleBox() {
  showDialog(
    ...
    builder: (BuildContext context) {
      return PREMIXconSTfull();
    },
  );
}

class PREMIXconSTfull extends StatefulWidget {
  const PREMIXconSTfull({Key? key}) : super(key: key);

  @override
  State<PREMIXconSTfull> createState() => _PREMIXconSTfullState();
}

class _PREMIXconSTfullState extends State<PREMIXconSTfull> {
  @override
